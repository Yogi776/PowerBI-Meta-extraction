...
[Units]),
    ...
    #"Removed Other Columns1" = Table.SelectColumns(#"Removed Columns",{"Year-Month", "Value", "Sub_Key_Account__c", "Organizational Element"}),
    #"Pivoted Column" = Table.Pivot(#"Removed Other Columns1", List.Distinct(#"Removed Other Columns1"[#"Year-Month"]), "Year-Month", "Value", List.Sum)
in
    #"Pivoted Column"