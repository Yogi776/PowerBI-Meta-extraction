let
    ...
    #"Product Dimension Key xlsx_https://harmar sharepoint com/sites/territorytracker/Shared Documents/General/" = Source{[Name="Product Dimension Key.xlsx",#"Folder Path"="https://harmar.sharepoint.com/sites/territorytracker/Shared Documents/General/"]}[Content],
    ...
    #"Filtered Rows" = Table.SelectRows(#"4  Set Stock Code Dimensions_Sheet", each [Column1] <> null and [Column1] <> ""),
